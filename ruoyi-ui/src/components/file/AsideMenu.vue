...
@import '~_a/styles/mixins.scss';.side-menu-wrapper  {
  position: relative;
  height: calc(100vh - 61px);
  padding-right: 11px;.side-menu  {

    height: calc(100vh - 127px);
    overflow: auto;
    @include setScrollbar(6px, transparent, #C0C4CC);.el-menu-item.is-active  {
      background: #ecf5ff;
    }.my-file, .recovery  {
     ...
     background: transparent;
      ...
      flex-wrap: wrap;
        ...
        padding: 0; ::v-deep  .el-progress--circle  {
      margin: 0 auto;
      width: 32px;
      display: block;
    }.text  {
       ...
       justify-content: center;
         ...
         line-height: 100px;
         cursor: pointer;
         border-radius: 0 16px 16px 0;&:hover  {
      opacity: 0.7;
    }.icon  {
       font-size: 12px;
     }
