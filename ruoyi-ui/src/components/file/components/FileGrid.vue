...
@import '~_a/styles/mixins.scss';.file-grid-wrapper  {
  border-top: 1px solid $BorderBase;.file-list  {
    ...
    list-style: none;
    @include setScrollbar(6px, transparent, #C0C4CC);.file-item  {
      ...
      cursor: pointer;
      z-index: 1;&:hover  {
        background: $tabBackColor;.file-name  {
          font-weight: 550;
        }
      }.file-name  {
         margin-top: 8px;
         ...
         @include setEllipsis(2); ::v-deep  .keyword  {
          color: $Danger;
        }
     ...
     z-index: 2;
     padding: 4px 0;
     color: $RegularText;.right-menu-item,
    .unzip-item  {
      padding: 0 16px;
      height: 36px;
      line-height: 36px;
