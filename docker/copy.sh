...
# copy sql
echo "begin copy sql "
cp ../sql-eduction/ry-clould-2022-01-05.sql ./mysql/db
cp ../sql-eduction/ry-config20220106.sql ./mysql/db
...
cp ../ruoyi-modules-eduction/education-admin/target/education-admin.jar ./ruoyi/modules-education/education-admin/jar
