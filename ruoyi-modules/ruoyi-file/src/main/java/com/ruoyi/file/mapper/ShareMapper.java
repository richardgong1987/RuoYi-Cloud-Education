...
public interface ShareMapper extends BaseMapper<Share> {
    ...
    List<ShareListVO> selectShareList(@Param("shareFilePath") String shareFilePath, String shareBatchNum, @Param("beginCount") Long beginCount, @Param("pageCount") Long pageCount, @Param("userId") long userId);
